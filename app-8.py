...
DAILY_TRIVIA = {
    TODAY_STR: [
        {"id": 0, "category": "Career Path", "question": "Who is this? Coyotes-Rangers-Panthers-Flyers", "answer": "Keith Yandle"},
        {
            "id": 1, 
            "category": "Guess who", 
            "question": "Who is pictured here?", 
            "answer": "Paul Millsap", 
            "image_url": "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Paul_Millsap_free_throw_%28cropped%29.jpg/250px-Paul_Millsap_free_throw_%28cropped%29.jpg"
        },
        {"id": 2, "category": "Who is #1", "question": "Who has the most fantasy points since 2020 for a non-QB??", "answer": "Davante Adams"},
        {"id": 3, "category": "College Sports", "question": "Ohio State was number #1 in NFL draft picks for Round 1 this most recent draft but who was second with three first round picks?", "answer": "Miami"},
        {"id": 4, "category": "Brothers?", "question": "Before the Brady Tkachuk trade, who was the last trade that joined brothers on the same team (I want the person traded to brothers team so for example if u thought it was Brady Tkachuk I just want his name)?", "answer": "Nick Foligno"},
        {"id": 5, "category": "Who Drafted Them?", "question": "Rajon Rondo (Just give team Nickname)?", "answer": "Suns"},
        {"id": 6, "category": "Home Run Hitters", "question": "In 2013, what AL East player hit 53 home runs and had 138 RBIs??", "answer": "Chris Davis"},
        {"id": 7, "category": "Same team Name", "question": "The NHL and MLB share one team name. What is it??", "answer": "Rangers"},
        {"id": 8, "category": "Nicknames", "question": "Who was know as T-Sizzle??", "answer": "Terrell Suggs"}
    ]
}
