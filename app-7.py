...
DAILY_TRIVIA = {
    TODAY_STR: [
        ...
        {"id": 2, "category": "Who is #1", "question": "Who has the most rushing + receiving tds since 2010 for the bengals?", "answer": "AJ Green"},
        ...
        {"id": 6, "category": "Who is missing?", "question": "2016 Stanley Cup Finals San Jose Sharks Game 6: Pavelski ____________ John Mccarthy Justin Braun Marc Eduardo Vlasic Martin Jones?", "answer": "Joe Thornton"},
